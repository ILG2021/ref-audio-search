"""
Model download utility backed exclusively by Hugging Face Hub.
...
def snapshot_download(repo_id: str, local_dir: str, revision=None, force_download=False, **kwargs) -> str:
    """Download an entire model repository from Hugging Face Hub."""
    from huggingface_hub import snapshot_download as _hf_snapshot
    logger.info(f"Downloading repo from Hugging Face: {repo_id}")
    return _hf_snapshot(
